...
| Skill                                                     | Description                                                                                                                                                                                                 |
| --------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [ansible-podman-quadlet](ansible-podman-quadlet/SKILL.md) | Deploy Podman workloads as systemd units with Ansible via the `containers.podman` collection — generate `.container`/`.pod`/`.network`/`.volume`/`.image` Quadlet files idempotently with `state: quadlet`. |
